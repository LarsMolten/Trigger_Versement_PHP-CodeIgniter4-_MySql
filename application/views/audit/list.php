...
<body>
    ...
    <?php $this->load->view('includes/header-sider'); ?>
      ...
      <div class="col-md-9 my-2 justify-content-center"> 
        <h2 class="text-center mb-3">Audit Versement</h2>
        <p>NBR Ajout : <?= $nbr_ajout ?></p>
        <p>NBR Modification : <?= $nbr_update ?></p>
        <p>NBR Suppression : <?= $nbr_delete ?></p>
